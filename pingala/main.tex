...
\begin{lstlisting}
    https://github.com/PradeepMundlik/EE3900/blob/master/pingala/codes/1.py
\end{lstlisting}
and run it using
\begin{lstlisting}
$ python3 1.py
...
Download the Python code using
\begin{lstlisting}
    https://github.com/PradeepMundlik/EE3900/blob/master/pingala/codes/2.1.py
\end{lstlisting}
and run it using
\begin{lstlisting}
$ python3 2.1.py
...
Download the Python code using
\begin{lstlisting}
    https://github.com/PradeepMundlik/EE3900/blob/master/pingala/codes/2.5.py
\end{lstlisting}
and run it using
\begin{lstlisting}
$ python3 2.5.py
